...
public final class DescribeJournal {
   ...
   public static DescribeJournal describeMessagesJournal(final File messagesDir) throws Exception {
      ...
      JournalImpl messagesJournal = new JournalImpl(defaultValues.getJournalFileSize(), defaultValues.getJournalMinFiles(), defaultValues.getJournalPoolSize(), 0, 0, messagesFF, "activemq-data", "amq", 1);
